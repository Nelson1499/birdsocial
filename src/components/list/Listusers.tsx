...
export default function Listusers ({
  ...
  return (
    <>
      ...
      <div className="w-[480px] h-[600px] bg-white dark:bg-black shadow shadow-gray-600 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-lg z-20">
